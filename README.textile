...
@curl -L https://github.com/ashishbista/oh-my-zsh/raw/master/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://raw.github.com/ashishbista/oh-my-zsh/master/tools/install.sh -O - | sh@
...
@curl -L https://raw.github.com/ashishbista/oh-my-zsh/master/tools/install.sh | ZSH=~/.dotfiles/zsh sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/ashishbista/oh-my-zsh.git ~/.oh-my-zsh@
...
* enable the plugins you want in your @~/.zshrc@ (take a look at the @plugins/@ directory and the "wiki":https://github.com/ashishbista/oh-my-zsh/wiki/Plugins to see what's possible)
** example: @plugins=(git osx ruby)@
* Theme support: Change the @ZSH_THEME@ environment variable in @~/.zshrc@.
** Take a look at the "current themes":https://wiki.github.com/ashishbista/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
...
h4. This repo has an extra theme than it's official version.
